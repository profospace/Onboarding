...
const FilterBar = ({ filters, onChange }) => {
    ...
    const clearFilters = () => {
        const emptyFilters = {
            ...
            latitude: '',
            longitude: '',
            radius: '' // for location-based search within radius
        };
        setLocalFilters(emptyFilters);
        onChange(emptyFilters);
        setIsOpen(false);
    ...
    return (
        <div className="relative">
            ...
            {isOpen && (
                <div className="absolute right-0 mt-2 w-80 bg-white rounded-lg shadow-lg z-10 border border-gray-200 p-4 max-h-96 overflow-y-auto">
                    <h3 className="font-medium text-gray-900 mb-3">Filter Leads</h3>

                    <div className="space-y-3">
                        {/* Crossed Status Filter */}
                        <div>
                            <label className="block text-sm font-medium text-gray-700 mb-1">Status</label>
                            <select
                                name="isCrossed"
                                value={localFilters.isCrossed}
                                onChange={handleChange}
                                className="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm"
                            >
                                <option value="">All Statuses</option>
                        ...
                        <div>
                            ...
                            <input
                                type="text"
                                name="salesman"
                                value={localFilters.salesman}
                                onChange={handleChange}
                                placeholder="Enter salesman name or ID"
                                className="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm"
                            />
                        </div>
                        ...
                        <div>
                            ...
                            <input
                                type="text"
                                name="ownerContact"
                                value={localFilters.ownerContact}
                                onChange={handleChange}
