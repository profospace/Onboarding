...
//             leadFormData.append('propertyType', formData.propertyType);

//             // Add property size if provided
//             if (formData.propertySize.value) {
//                 leadFormData.append('propertySize', JSON.stringify({
//                     value: Number(formData.propertySize.value),
//                     unit: formData.propertySize.unit,
//                 }));
//             }
...
//                         <h1 className="text-3xl font-bold text-white">Create New Property Lead</h1>
...
//                                         onClick={getCurrentLocation}
//                                         disabled={loadingLocation}
//                                         className={`flex items-center justify-center px-4 py-2 rounded-lg text-white font-medium transition-all w-full
//                                         ${loadingLocation
//                                                 ? 'bg-gray-400 cursor-not-allowed'
//                                                 : 'bg-blue-600 hover:bg-blue-700 shadow-md hover:shadow-lg'
//                                             }`}
...
//                                 <div className="space-y-2">
//                                     <label className="block text-sm font-medium text-gray-700">
//                                         Location Map * (Click on map to set location)
//                                     </label>
//                                     <div className="border border-gray-300 rounded-lg overflow-hidden">
//                                         <GoogleMap
//                                             mapContainerStyle={mapContainerStyle}
