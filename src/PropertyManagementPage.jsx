...
//             await axios.patch(
//                 `${API_BASE_URL}/properties/${selectedPropertyId}/status`,
...
//             await axios.patch(
//                 `${API_BASE_URL}/properties/${selectedPropertyId}/reassign`,
...
//             await axios.delete(`${API_BASE_URL}/properties/${selectedPropertyId}`, {
//                 headers: { Authorization: `Bearer ${details?.token}` }
//             });
...
//             await axios.post(
//                 `${API_BASE_URL}/properties/bulk-update-status`,
//                 {
