...
function SalesmanCommercialLeads() {
    // Form state
    ...
    // Common function to add images to collection
    ...
    const handleCameraCapture = (imageFile) => {
        addImagesToCollection([imageFile]);
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const response = await axios.post(`${base_url}/api/salesman/commercial/leads`, leadFormData, {
                headers: {
        ...
        <div className="min-h-screen bg-gradient-to-b from-blue-50 to-white py-6 px-4">
            <div className="max-w-7xl mx-auto">
                <div className="bg-white rounded-2xl shadow-xl overflow-hidden">
                    {/* Header */}
                    <div className="bg-gradient-to-r from-[crimson] to-indigo-700 px-6 py-6 relative">
                        <h1 className="text-2xl md:text-3xl font-bold text-white">Create New Commercial Lead</h1>
                                ...
                                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-4">
                                    ...
                                    <div className="flex items-center justify-center w-full">
                                        <button
                                            ...
                                            disabled={images.length >= 4}
                                            className="flex flex-col items-center justify-center w-full h-32 border-2 border-dashed border-blue-300 rounded-lg bg-blue-50 hover:bg-blue-100 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                                        >
                                            ...
                                            <p className="text-xs text-blue-500">Use Camera</p>
                                        </button>
                                    </div>
                                </div>
...
export default SalesmanCommercialLeads;