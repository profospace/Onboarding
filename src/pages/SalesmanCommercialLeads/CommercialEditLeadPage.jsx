    ...
    useEffect(() => {
        const fetchLead = async () => {
            try {
                ...
                const response = await axios.get(`${base_url}/api/salesman/commercial/leads/${id}`, {
                    headers: {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (hasNewImages || hasRemovedImages) {
                ...
                await axios.put(
                    `${base_url}/api/salesman/commercial/leads/${id}`,
                    leadFormData,
                    {
                        headers: {
                            Authorization: `Bearer ${user.token}`,
...
export default CommercialEditLeadPage;